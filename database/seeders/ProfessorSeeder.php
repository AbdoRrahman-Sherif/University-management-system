...
class ProfessorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::statement("
            INSERT INTO professors (id, name, university_email, national_id, password, date_of_birth, gender, faculty_id, created_at, updated_at)
            VALUES ($professorId, '$professorName', '$email', '2233444556', '$password', '1985-1-1', 'Male', 1, NOW(), NOW())
        ");
        ...
        DB::statement("
            INSERT INTO professors (id, name, university_email, national_id, password, date_of_birth, gender, faculty_id, created_at, updated_at)
            VALUES ($professorId, '$professorName', '$email', '2232344556', '$password', '1985-1-1', 'Male', 1, NOW(), NOW())
        ");
    }
}

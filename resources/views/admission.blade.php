...
<html>
    ...
    <body>
        ...
        <main>
            <div class="contanier">
                <h1 class="form_title">Undergraduate Addmission</h1>

                <form method="POST" action="{{ route('admission.store') }}" id="form" name="form">
                    @csrf
                    <div class="main_user_info">
                            ...
                            <div class="user_input_box">
                                ...
                                <input type="text" id="national_id" name="national_id" placeholder="  01*********" required>
                            </div>

                            <div class="user_input_box">
                                <label for="email">E-mail</label>
                                <input type="text" id="email" name="email" placeholder="  example@web.com" required>
                            </div>
                            ...
                            <div class="user_input_box">
                                ...
                                <label for="application_type">Choose Application Type</label>
            ...
            <div class="contanier">
                <h1 class="form_title">Login instead</h1>
